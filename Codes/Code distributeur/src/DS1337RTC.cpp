...
void DS1337RTC::write(tmElements_t &tm, int address)
{
  ...
  if(address == ALARM1_ADDRESS || address == ALARM2_ADDRESS){  // the alarms don't have a wday,day,month,or year field
    Wire.write(0b00000000 | dec2bcd(tm.Minute)); // alarm everyday
    Serial.println(0b00000000 | dec2bcd(tm.Minute));
    Wire.write(0b00000000 | dec2bcd(tm.Hour));
    Wire.write(0b10000000 | dec2bcd(tm.Day));
  }else{
